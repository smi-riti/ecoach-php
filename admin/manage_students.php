...
<head>
    ...
    <title> MAnage students | Admin Panel - Ecoach | An Application for coaching</title>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <?php if ($value['status'] == 2){
                                            echo "<span class = 'badge bg-danger text-white'>Disables</span>";
                                    ...
                                    <td>
                                        <div class="btn-group">
                                            ...
                                            <?php if($value['status'] == 1):?>
                                                <a href="?disabled=<?= $value['roll'];?>" class="btn btn-danger">Disabled</a>
                                                <?php endif;?>
